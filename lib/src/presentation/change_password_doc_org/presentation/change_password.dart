...
import 'package:medical_app/src/presentation/change_password_doc_org/domain/service/change_user_pwd_services.dart';
    ...
    return GestureDetector(
      ...
      child: Scaffold(
        ...
        appBar: AppBar(
          ...
          title: Text('Change Password',style: getMediumStyle(color: ColorManager.white),),
          centerTitle: true,
          leading: IconButton(
              onPressed:()=>Get.back(),
                  ...
                  ElevatedButton(
                    style: ElevatedButton.styleFrom(
                      ...
                      child: _isPosting
                          ...
                          :Text('Confirm Password',style: getMediumStyle(color: ColorManager.white,fontSize: 16),)
                  )
                ],
              )
          ),
