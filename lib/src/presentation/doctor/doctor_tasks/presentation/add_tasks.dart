                    ...
                    child: InkWell(
                      ...
                      child: Container(
                        ...
                        decoration: BoxDecoration(
                          ...
                          color: selectPriority == 1? ColorManager.red.withOpacity(0.5):Colors.transparent
                        ),
                        child: Text('High',style: getRegularStyle(color:selectPriority == 1?ColorManager.white: ColorManager.black,fontSize: 20.sp),),
                      ),
                    ),
                  ),
                  w10,
                    ...
                    child: InkWell(
                      ...
                      child: Container(
                        ...
                        decoration: BoxDecoration(
                            ...
                            color: selectPriority == 2? ColorManager.blueText.withOpacity(0.7):Colors.transparent
                        ),
                        child: Text('Low',style: getRegularStyle(color:selectPriority == 2?ColorManager.white: ColorManager.black,fontSize: 20.sp),),
                      ),
                    ),
                  ),
