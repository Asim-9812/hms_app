...
class EditMedReminderPageCopy extends ConsumerStatefulWidget {
  final Reminder reminderTest;

  EditMedReminderPageCopy(this.reminderTest);

  @override
  _EditReminderPageState createState() => _EditReminderPageState();
}

class _EditReminderPageState extends ConsumerState<EditMedReminderPageCopy> {
